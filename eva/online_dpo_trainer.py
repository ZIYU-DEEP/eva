...
class OnlineDPOTrainer(Trainer):
    ...
    def __init__(
        ...
        self.generation_config = GenerationConfig(
            ...
            # min_new_tokens=args.min_new_tokens,  # DEBUG - TO USE min_new_tokens
            temperature=0.7,  # DEBUG - TO USE ARG
            top_k=None, # DEBUG - TO USE ARG
...
# - compatibility with gemma-2-9b-it / gemma-2-2b-it
# - comptatibility with the other reward models
# - baseline results 
# - prompt selection strategy
# - prompt evolving strategy
# - the whole pipeline
