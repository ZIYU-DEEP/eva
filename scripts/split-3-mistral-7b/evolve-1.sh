...
# bash ./scripts/split-3-mistral-7b/evolve-create-gen-iter-1.sh
# bash ./scripts/split-3-mistral-7b/evolve-create-iter-1.sh
# bash ./scripts/split-3-mistral-7b/evolve-gen-iter-1.sh
# bash ./scripts/split-3-mistral-7b/evolve-train-iter-1.sh

# General parameters
SPLIT=1
ITER=1
MODEL_FAMILY="mistral-7b-it"
...
source ./scripts/split-3-mistral-7b/evolve-create-gen-iter-1.sh
source ./scripts/split-3-mistral-7b/evolve-create-iter-1.sh
source ./scripts/split-3-mistral-7b/evolve-gen-iter-1.sh
source ./scripts/split-3-mistral-7b/evolve-train-iter-1.sh
