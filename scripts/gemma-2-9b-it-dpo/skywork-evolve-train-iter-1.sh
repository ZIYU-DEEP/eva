...
DATASET_PREFIX="${DATASET_PREFIX}-skywork27"
# ------------------------------------------------------------------
...
DATASET="${DATASET_BASE}-evol-${SAMPLE_METRIC}-${SAMPLE_FRAC}-mixed"  # TOO LONG. SHORTER IT
...
# ------------------------------------------------------------------
# MODIFY FOR THE REWARD MODEL
SAVE_DIR="checkpoints/${MODEL_FAMILY}-${LOSS_TYPE}-iter-${ITER}-skywork27-evol-${EVOL_NO}-${SAMPLE_METRIC}-${SAMPLE_FRAC}"
HUB_MODEL_ID="${HF_USERNAME}/${MODEL_FAMILY}-${LOSS_TYPE}-iter-${ITER}-skywork27-evol-${EVOL_NO}-${SAMPLE_METRIC}-${SAMPLE_FRAC}"
# ------------------------------------------------------------------
