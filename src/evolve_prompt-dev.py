...
from distilabel.llms import OpenAILLM, LiteLLM, vLLM
...
def evolve_chunk(instructions,
    ...
    # Using vllm
    # llm = vLLM(model='google/gemma-1.1-2b-it',
    #         tokenizer='google/gemma-1.1-2b-it',
    #         dtype='float16',
    # )
    
    llm = LiteLLM(model=gen_model_name)
    llm.generation_kwargs = {
        "max_tokens": max_prompt_length,  # TODO: too large may lead to api error; original 2048
        "temperature": evolve_temperature,
        }  
